...
import (
	...
	mockdb "github.com/msarifin29/simple_bank/db/mock"
	...
	testCase := []struct {
	...
	}{
		{
			...
			checkResponse: func(recorder *httptest.ResponseRecorder) {
				...
				requiredBodymatcherUser(t, recorder.Body, user)
			},
		},
		{
			name: "InternalError",
...
func requiredBodymatcherUser(t *testing.T, body *bytes.Buffer, user db.User) {
